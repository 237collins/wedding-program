    ...
    <div className="min-h-[90vh] flex flex-col items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden opacity-10">
        <div
          ...
          style={{ background: `radial-linear(circle, ${theme === 'dark' ? '#E2725B40' : '#E2725B20'} 0%, transparent 70%)` }}
        />
        <div
          className="absolute bottom-1/4 right-1/4 w-80 h-80 rounded-full blur-3xl"
          style={{ background: `radial-linear(circle, ${theme === 'dark' ? '#80000040' : '#80000020'} 0%, transparent 70%)` }}
        />
      </div>
        ...
        <div className="relative w-56 h-56 md:w-72 md:h-72 mx-auto mb-10 rounded-full overflow-hidden border-4 border-white/40 shadow-2xl">
          <div className="relative w-full h-full">
            ...
            <div className={`absolute inset-0 rounded-full ${theme === 'dark'
                ? 'bg-linear-to-br from-[#2a0a0a] to-[#3a1a1a]'
                : 'bg-linear-to-br from-[#FFF5F0] to-[#FFE8E0]'
              }`} />
            ...
            <div className={`absolute inset-0 rounded-full mix-blend-overlay transition-all duration-500 ${theme === 'dark'
                ? 'bg-linear-to-t from-[#1a0a0a]/40 via-transparent to-transparent'
                : 'bg-linear-to-t from-white/10 via-transparent to-transparent'
              }`} />
            ...
            <div className={`absolute inset-0 rounded-full mix-blend-soft-light transition-all duration-500 ${theme === 'dark'
                ? 'bg-linear-to-br from-[#E2725B]/10 via-[#800000]/5 to-transparent'
                : 'bg-linear-to-br from-[#E2725B]/5 via-[#800000]/3 to-transparent'
              }`} />
            ...
            {/* Effet de lumière */}
            <div className={`absolute inset-0 rounded-full bg-linear-to-tr from-transparent ${theme === 'dark'
      ...
      >
        <h1 className="font-wedding text-4xl md:text-6xl text-center script-linear script-linear-animated script-shadow">
          <span className="bg-linear-to-r from-[#E2725B] to-[#800000] bg-clip-text text-transparent block">{first}</span>
          <span className="bg-linear-to-r from-[#E2725B] to-[#800000] bg-clip-text text-transparent block">&</span>
          <span className="bg-linear-to-r from-[#E2725B] to-[#800000] bg-clip-text text-transparent block">{second}</span>
        </h1>
        ...
        <motion.div
          ...
          className="h-0.5 bg-linear-to-r from-[#E2725B] to-[#800000] mx-auto mb-6"
        />
