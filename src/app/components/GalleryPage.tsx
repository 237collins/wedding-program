  ...
  return (
    <div className="py-10 px-4">
      ...
      <div className="text-center mb-12">
        <h2 className="font-wedding text-5xl md:text-6xl text-center script-linear script-linear-animated script-shadow mb-6">
          <span className="bg-linear-to-r from-[#0389f6] to-[#2435b3] bg-clip-text text-transparent">
            {title}
          </span>
        </h2>
        <p
          className={`text-lg italic ${theme === 'dark' ? 'text-[#0389f6]' : 'text-[#2435b3]'
            }`}
        >
          {subtitle}
        </p>
