      ...
      >
        ...
        >
          ...
          <div className="absolute top-4 left-4 w-6 h-6 border-t-2 border-l-2"
            style={{ borderColor: theme === 'dark' ? '#E2725B' : '#292C43' }}
          />
          ...
          {title && (
            <h2 className="font-wedding text-4xl md:text-6xl text-center script-linear script-linear-animated script-shadow mb-4 sm:mb-6 px-2">
              <span className="bg-linear-to-r from-[#E2725B] to-[#292C43] bg-clip-text text-transparent break-words">
                {title}
              </span>
            </h2>
          )}

          <p className={`text-lg md:text-xl leading-relaxed whitespace-pre-line ${theme === 'dark' ? 'text-[#FFD1C4]' : 'text-[#FF9671]'
            } font-serif mb-8`}>
            {text}
          </p>
          ...
          {subtitle && (
            <motion.div
              ...
              className={`mt-8 pt-8 border-t ${theme === 'dark' ? 'border-[#E2725B]/20' : 'border-[#292C43]/20'}`}
            >
              <div className="flex flex-col items-center gap-4">
                <div className="flex items-center gap-3 mb-2">
                  <div className={`p-3 rounded-full ${theme === 'dark' ? 'bg-[#2a0a0a]' : 'bg-[292C43]'}`}>
                    <div className="relative">
                      ...
                      <motion.div
                        ...
                        style={{ background: theme === 'dark' ? '#E2725B' : '#292C43' }}
                      />
                  ...
                  <h3 className={`text-xl font-bold ${theme === 'dark' ? 'text-[#FFD1C4]' : 'text-[#292C43]'}`}>
                    {subtitle}
                  </h3>
                </div>

                <p className={`text-sm md:text-base font-semibold ${theme === 'dark' ? 'text-[#FFD1C4]/80' : 'text-[#292C43]/80'} mb-4`}>
                  {subdesc}
                </p>
                ...
                >
                  <a
                    ...
                    className={`px-6 py-3 rounded-full font-semibold flex items-center gap-2 ${theme === 'dark'
                      ? 'bg-linear-to-r from-[#E2725B] to-[#292C43] text-white'
                      : 'bg-linear-to-r from-[#FF7A5C] to-[#B84A4A] text-white'
                ...
                <div className="flex items-center gap-2 mt-3">
                  <span className={`text-xs ${theme === 'dark' ? 'text-[#FFD1C4]/60' : 'text-[#292C43]/60'}`}>
                    ⏰ {limit}
                  </span>
                </div>
              </div>
        ...
        <motion.div
          ...
          className={`pt-6 md:pt-8 mt-6 md:mt-8 border-t ${theme === 'dark' ? 'border-[#E2725B]/30' : 'border-[#292C43]/30'}`}
        >
          <p className={`text-xl md:text-2xl font-serif italic ${theme === 'dark' ? 'text-[#FFD1C4]' : 'text-[#292C43]'}`}>
            Avec tout notre amour
          </p>
          <div className="flex justify-center gap-3 md:gap-4 mt-3 md:mt-4 font-wedding">
            <span className={`text-lg font-semibold ${theme === 'dark' ? 'text-[#FFD1C4]/70' : 'text-[#292C43]/70'}`}>
              Faveur
            </span>
            <span className={`text-lg font-semibold ${theme === 'dark' ? 'text-[#FFD1C4]/70' : 'text-[#292C43]/70'}`}>
              &
