...
export default function WeddingCatalogue() {
  ...
  return (
    <div className={`min-h-screen transition-colors duration-500 overflow-x-hidden ${theme === 'dark'
      ? 'bg-linear-to-br from-[#1a0a0a] via-[#2a0a0a] to-[#1a0a0a] text-gray-100'
      : 'bg-linear-to-br from-[#FFF9F7] via-[292C43] to-[#FFF0EB] text-gray-900'
      }`}>
        ...
        {[...Array(15)].map((_, i) => (
          <motion.div
            ...
            className={`absolute rounded-full ${theme === 'dark'
              ? 'bg-linear-to-r from-[#E2725B]/10 to-[#292C43]/10'
              : 'bg-linear-to-r from-[#E2725B]/20 to-[#FFD1C4]/20'
              }`}
            style={{
      ...
      {/* Progress bar */}
      <div className="fixed top-0 left-0 right-0 h-1 z-50 bg-linear-to-r from-[#E2725B] to-[#292C43]">
        <motion.div
      ...
      <div className="fixed top-6 left-1/2 transform -translate-x-1/2 z-40">
        <motion.div
          ...
          className={`px-4 py-2 rounded-full backdrop-blur-md border ${theme === 'dark'
            ...
            : 'bg-white/70 border-[#E2725B]/30 text-[#292C43]'
            } shadow-lg`}
        >
